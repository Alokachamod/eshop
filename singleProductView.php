                                                    ...
                                                    <div class="col-12 my-2">
                                                        <div class="row g-2">
                                                            <div class="col-12 col-lg-6 border border-1 border-dark text-center">
                                                                <span class="fs-5 text-primary"><?php echo ($product_data["user_email"]); ?></span>
                                                            </div>
                                                            <div class="col-12 col-lg-6 border border-1 border-dark text-center">
                                                    ...
                                                    <div class="col-12 mt-5">
                                                        <div class="row">
                                                            <div class="col-6 d-grid">
                                                                <a href='<?php echo "singleProductView.php?id=" . ($product_data["id"]); ?>' class="btn btn-success" type="submit" id="payhere-payment">Buy Now</a>
                                                            </div>
                                                            <div class="col-6 d-grid">
                                                                <button class="btn btn-primary" onclick='addToCart(<?php echo ($product_data["id"]); ?>)'>Add To Cart</button>
                                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="row">
                                            ...
                                            <div class="col-9">
                                                <label class="form-label fs-4">iPhone 13</label>
                                            </div>
                                        </div>
                                    </div>
