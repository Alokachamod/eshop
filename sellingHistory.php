                        ...
                        <div class="row  mt-2">
                            ...
                            <div class="col-2 bg-white d-grid">
                                ...
                                ?>
                                    ...
                                    <button class="btn btn-outline-success fw-bold mt-1 mb-1" onclick="changeInvoiceStatus('<?php echo ($selected_data['id']); ?>')" id="btn<?php echo ($selected_data["id"]); ?>">Confirm Order</button>
                                ...
                                ?>
                                    ...
                                    <button class="btn btn-outline-warning fw-bold mt-1 mb-1" onclick="changeInvoiceStatus('<?php echo ($selected_data['id']); ?>')" id="btn<?php echo ($selected_data["id"]); ?>">Packing</button>
                                ...
                                ?>
                                    ...
                                    <button class="btn btn-outline-info fw-bold mt-1 mb-1" onclick="changeInvoiceStatus('<?php echo ($selected_data['id']); ?>')" id="btn<?php echo ($selected_data["id"]); ?>">Dispatch</button>
                                ...
                                ?>
                                    ...
                                    <button class="btn btn-outline-primary fw-bold mt-1 mb-1" onclick="changeInvoiceStatus('<?php echo ($selected_data['id']); ?>')" id="btn<?php echo ($selected_data["id"]); ?>">Shipping</button>
                                ...
                                ?>
                                    ...
                                    <button class="btn btn-outline-danger fw-bold mt-1 mb-1 disabled" onclick="changeInvoiceStatus('<?php echo ($selected_data['id']); ?>')" id="btn<?php echo ($selected_data["id"]); ?>">Delivered</button>
                            ...
                            <ul class="pagination pagination-lg justify-content-center">
                                <li class="page-item">
                                    <a class="page-link" href="<?php if ($pageno <= 1) {
                                                                    ...
                                                                    echo ("sellingHistory.php?page=" . $pageno - 1);
                                                                }
                                                                ?>" aria-label="Previous">
                                ...
                                ?>
                                        <li class="page-item active">
                                            <a class="page-link" href="<?php echo "sellingHistory.php?page=" . ($x) ?>"><?php echo $x; ?></a>
                                        </li>
                                    <?php
                                    } else {
                                    ?>
