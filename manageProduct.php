        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-12 bg-light text-center mb-3">
                    <label class="form-label fs-1 text-primary fw-bold">Manage All Products</label>
                </div>
                ...
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-2 d-none d-lg-block bg-light py-2">
                            <Span class="fw-bold fs-4">Product Image</Span>
                        </div>
                        ...
                        <div class="col-4 col-lg-2 d-none d-lg-block bg-light py-2 text-end">
                            <span class="fs-4 fw-bold">Price</span>
                        </div>

                        <div class="col-2 d-none d-lg-block bg-primary py-2 text-end">
                            <span class="fs-4 fw-bold text-white">Quantity</span>
                        </div>

                        <div class="col-2 d-none d-lg-block bg-light py-2 text-end">
                            <span class="fs-4 fw-bold">Uploaded Date</span>
                        </div>
                    ...
                    <div class="col-12 mt-3 mb-3">
                        <div class="row">
                            ...
                            <div class="col-2 d-none d-lg-block bg-light py-2" onclick="viewProductModal('<?php echo ($selected_data['id']); ?>');">
                                <img src="<?php echo ($img_data["code"]); ?>" class="rounded" style="height: 40px; margin-left: 80px;" />
                            </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="offset-4 col-4">
                                        <img src="<?php echo ($img_data["code"]); ?>" class="img-fluid" style="height: 120px;">
                                    </div>
                                    <div class="col-12">
                                        <span class="fs-5 fw-bold">Price :</span>&nbsp;
                                        <span class="fs-5">Rs. <?php echo ($selected_data["price"]); ?> .00</span><br>
                                        <span class="fs-5 fw-bold">Quantity :</span>&nbsp;
                                        <span class="fs-5"><?php echo ($selected_data["qty"]); ?> Items Left</span><br>
                                        <span class="fs-5 fw-bold">Seller :</span>&nbsp;
                                        <span class="fs-5"><?php echo ($selected_data["user_email"]); ?></span><br>
                        ...
                        <ul class="pagination pagination-lg justify-content-center">
                            <li class="page-item">
                                <a class="page-link" href="<?php if ($pageno <= 1) {
                                                                ...
                                                                echo ("manageProduct.php?page=" . $pageno - 1);
                                                            }
                                                            ?>" aria-label="Previous">
                            ...
                            ?>
                                    <li class="page-item active">
                                        <a class="page-link" href="<?php echo "manageProduct.php?page=" . ($x) ?>"><?php echo $x; ?></a>
                                    </li>
                                <?php
                                } else {
                                ?>
                ...
                <div class="col-12 mb-3">
                    <div class="row justify-content-center gap-1">
                        ...
                        <div class="col-12 col-lg-3 border border-warning rounded" style="height: 50px;" onclick="addNewCategory();">
                            <div class="row">
                                ...
                                <div class="col-4 border-start border-secondary text-center mt-2">
                                    <label class="form-label fs-4"><i class="bi bi-plus-square-fill text-warning"></i></label>
                                </div>
                        ...
                        <div class="modal" tabindex="-1" id="addCategoryModal">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title fs-3 text-primary fw-bold">Add New Category</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
