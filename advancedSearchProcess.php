...
if ($sort == 0) {
    ...
    if ($brand == 0 && $model != 0) {
        ...
        if ($status == 0) {
            ...
            $query .= " AND `brand_has-model_id`='" . $pid . "'";
        }
    }

    if ($brand != 0 && $model != 0) {

        $model_has_brand_rs = Database::search("SELECT * FROM `brand_has_model` WHERE `brand_id`='" . $brand . "' AND `model_id`='" . $model . "'");
        ...
        if ($status == 0) {
            $query .= " WHERE `brand_had_model_id`='" . $pid . "'";
            $status = 1;
        } else if ($status != 0) {
            $query .= " AND `brand_has_model_id`='" . $pid . "'";
        }
    ...
    <div class="card mb-3 mt-3 col-12 col-lg-6">
        <div class="row">
            ...
            <div class="col-md-4 mt-4">
                ...
                <img src="<?php echo $product_img_data["code"]; ?>" class="card-img-top img-thumbnail mt-2">
            </div>
            <div class="col-md-8">
                <div class="card-body">
